...
-- Query 1: All airports ranked by delay rate (DESC)
-- Result time: ~1.0 second vs ~45 seconds in Hive
SELECT
    pk                AS airport_code,
    "city",
    "avg_dep_delay",
...
-- Result time: ~0.8 second vs ~45 seconds in Hive
SELECT
    pk                AS carrier_code,
...
-- Query 3: Single airport real-time lookup (JFK)
-- This is the key use case — instant response for dashboards
-- Result time: ~0.5 second
SELECT
    pk                AS airport,
    "city",
    "avg_dep_delay",
